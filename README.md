...
Requires macOS 14 or newer and Xcode with Swift 6 support. Open `Package.swift` in Xcode and run the DataRevival executable, or run `swift run DataRevival` from this directory.
